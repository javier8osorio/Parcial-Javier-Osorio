...
# ejercicio 4 -->
esfera = Esfera()
result = esfera.definicionEsfera(12)
if result == {
    "perimetro": 75.39822368615503,
    "area": 1809.5573684677208,
    "volumen": 7238.229473870882,
...
# ejercicio 5 -->
banco = Banco()
banco.procesar("balbino", "san salvador", 1, "abono", 250.0)
banco.procesar("rodrigo", "san salvador", 2, "retiro", 350.0)
banco.procesar("marta", "san salvador", 3, "abono", 400.0)
banco.procesar("rafael", "santa ana", 4, "abono", 500.0)
banco.procesar("balbino", "la libertad", 1, "abono", 250.0)
banco.procesar("marta", "san salvador", 3, "abono", 250.0)
banco.procesar("rodrigo", "san salvador", 2, "abono", 100.0)
